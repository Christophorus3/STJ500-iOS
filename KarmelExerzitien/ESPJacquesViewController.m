...
#import "ESPJacquesViewController.h"

@interface ESPJacquesViewController ()

@property (nonatomic, weak) IBOutlet UIBarButtonItem *revealButton;

@end

@implementation ESPJacquesViewController


- (void)viewDidLoad
{
    //self.contentURL = [[NSBundle mainBundle] URLForResource:NSLocalizedString(@"pjacques", nil) withExtension:@"html"];
	self.contentURL = [[NSBundle mainBundle] URLForResource:@"pjacques" withExtension:@"html"];
